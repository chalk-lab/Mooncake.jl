...
makedocs(;
    ...
    pages=[
        ...
        "Developer Documentation" => [
            ...
            joinpath("developer_documentation", "compiler_investigation_playbook.md"),
            joinpath("developer_documentation", "compiler_mwe_patterns.md"),
            joinpath("developer_documentation", "compiler_source_map.md"),
            joinpath("developer_documentation", "compiler_version_policy.md"),
            joinpath("developer_documentation", "internal_docstrings.md"),
        ],
