...
function TestUtils.has_equal_data_internal(
    x::ROCArray{P,N,M}, y::ROCArray{P,N,M}, equal_undefs::Bool, d::Dict{Tuple{UInt,UInt},Bool}
...
function _scale_internal(c::MaybeCache, x::Float64, y::P) where {T<:IEEEFloat,P<:ROCArray{T}}
