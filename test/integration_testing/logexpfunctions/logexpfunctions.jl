    ...
    @testset for (perf_flag, is_primitive, f, x...) in vcat(
        map([Float64, Float32]) do P
            return Any[
                ...
                (:allocs, true, xexpx, -P(0.5)),
                (:allocs, true, xexpy, P(1.0), -P(0.7)),
                (:allocs, true, logistic, P(0.5)),
                (:allocs, true, logistic, P(1000.0)),
                (:allocs, true, logit, P(0.3)),
                (:allocs, true, logcosh, P(1.5)),
                (:allocs, true, logabssinh, P(0.3)),
                (:allocs, true, log1psq, P(0.3)),
                (:allocs, true, log1pexp, P(0.1)),
                (:allocs, true, log1mexp, -P(0.5)),
                (:allocs, true, log2mexp, P(0.1)),
                (:allocs, true, logexpm1, P(0.1)),
                ...
                (:none, true, logsumexp, randn(sr(1), P, 5)),
                (:none, true, logsumexp, randn(sr(2), P, 5, 4)),
                (:none, true, logsumexp, randn(sr(3), P, 5, 4, 3)),
                # edge case with two equal inputs: see #881 for discussion
                (:none, true, logsumexp, [1.0, 1.0]),
                ...
                (:none, false, logsumexp!, rand(sr(6), 5), randn(sr(7), P, 5, 4)),
                (:none, false, softmax, randn(sr(7), P, 10)),
                (:allocs, true, cloglog, P(0.5)),
                (:allocs, true, cexpexp, -P(0.3)),
