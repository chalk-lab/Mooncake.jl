...
@testset "logexpfunctions" begin
    @testset for (perf_flag, rtol, is_primitive, f, x...) in vcat(
        map([Float64, Float32]) do P
            return Any[
                (:allocs, nothing, true, xlogx, P(1.1)),
                (:allocs, nothing, true, xlogy, P(0.3), P(1.2)),
                (:allocs, nothing, true, xlog1py, P(0.3), -P(0.5)),
                (:allocs, nothing, true, xexpx, -P(0.5)),
                (:allocs, nothing, true, xexpy, P(1.0), -P(0.7)),
                (:allocs, nothing, true, logistic, P(0.5)),
                (:allocs, nothing, true, logistic, P(1000.0)),
                (:allocs, nothing, true, logit, P(0.3)),
                (:allocs, nothing, true, logcosh, P(1.5)),
                (:allocs, nothing, true, logabssinh, P(0.3)),
                (:allocs, nothing, true, log1psq, P(0.3)),
                (:allocs, nothing, true, log1pexp, P(0.1)),
                (:allocs, nothing, true, log1mexp, -P(0.5)),
                (:allocs, nothing, true, log2mexp, P(0.1)),
                (:allocs, nothing, true, logexpm1, P(0.1)),
                (:allocs, nothing, true, log1pmx, -P(0.95)),
                (:allocs, nothing, true, logmxp1, P(0.02)),
                (:allocs, nothing, true, logaddexp, -P(0.5), P(0.4)),
                (:allocs, 1e-2, true, logaddexp, P(1000.0), P(1000.0)),
                (:allocs, nothing, true, logsubexp, -P(0.5), -P(5.0)),
