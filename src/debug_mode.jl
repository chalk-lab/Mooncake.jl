...
# Check types only: canonical seeds keep NDualArray partials axes aligned with the
# primal; runtime axis mismatches surface in array ops, unlike reverse's structural walk.
