...
function hand_written_rule_test_cases(rng_ctor, ::Val{:builtins})
    ...
    test_cases = Any[
        ...
        # Int-indexed getfield on StructFoo is slower (~290x) than Symbol-indexed.
        (true, :none, (lb=1e-3, ub=350), getfield, StructFoo(5.0), 1),
        (false, :none, (lb=1e-3, ub=350), getfield, StructFoo(5.0, randn(5)), 1),
        (false, :none, (lb=1e-3, ub=350), getfield, StructFoo(5.0, randn(5)), 2),
